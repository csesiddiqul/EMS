                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        @if (Auth::guard('admin')->user()->can('admin.edit'))
                                            <a class="btn btn-outline-info m-2" href="{{ route('admin.admins.edit', $admin->id) }}">Edit</a>
                                        @endif

                                        @if (Auth::guard('admin')->user()->can('admin.delete'))
                                        <a class="btn btn-outline-danger m-2" href="{{ route('admin.admins.destroy', $admin->id) }}"
