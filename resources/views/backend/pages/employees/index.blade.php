                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="float-right mb-2">
                            <a class="btn btn-primary text-white" href="{{ route('admin.employees.create') }}">New Employee</a>
                        </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @foreach($departments as $depData)
                                                ...
                                                {{$empData->department_id == $depData->id ? $depData->dep_name : ''}}
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @foreach($designations as $degData)
                                                ...
                                                {{$empData->designation_id  == $degData->id ? $degData->deg_name : ''}}
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-form-{{ $empData->id }}" action="{{ route('admin.employees.destroy', $empData->id) }}" method="POST" style="display: none;">
                                                @method('DELETE')
                                                @csrf
                                            </form>
                                        </td>
